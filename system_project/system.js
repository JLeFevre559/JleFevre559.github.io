        ...
        let planet_html = '<div class="planet container" id="' + planet.name + '" style="position:absolute; left:' + real_position[0] + 'px; top:' + real_position[1] +'px;">';
                planet_html += '<div class="row">';
                    ...
                    planet_html += '<div class="planet_model col-sm">';
                        ...
                        planet_html += '<model-viewer alt="' + planet.name + '" src="assets/3d/'+ planet.name +'.glb" ar environment-image="assets/3d/moon_1k.hdr" poster="" shadow-intensity="1" touch-action="pan-y" disable-pan auto-rotate rotation-per-second=0.1rad disable-tap style="transform: rotate('+ planet.axial_tilt+ 'deg);" width:"'+ 100*planet_scale + 'px" height:"' + 100*planet_scale +'px"></model-viewer>';
